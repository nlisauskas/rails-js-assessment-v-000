...
[ ] Use your Rails API and a form to create a resource and render the response without a page refresh.  A form needs to be submitted with an AJAX request. The controller needs to create an object, then return a JSON representation of the object that you append to the DOM.
[ ] Translate JSON responses into js model objects.  You can use either ES6 class syntax or JS constructor function syntax to make this happen. Either way is fine.
